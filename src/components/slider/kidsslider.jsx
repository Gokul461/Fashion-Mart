...
import kid1 from '../../assets/images/kidban1.jpg';
import kid2 from '../../assets/images/kidban2.avif';
import kid3 from '../../assets/images/kidban3.webp';
import kid4 from '../../assets/images/kidban4.avif';
import './slider.css'; 
    ...
    <div className='container-fluid mb-3 menslider'>
      ...
      >
        ...
        <div className="carousel-inner">
          ...
          <div className="carousel-item">
            <img className="d-block w-100" src={kid4} alt="Fourth slide" />
          </div>
        </div>
        <a
